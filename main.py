...
easter_egg_img = pygame.image.load('images/easteregg.png').convert_alpha()
back_img = pygame.image.load('images/button_back.png').convert_alpha()
logo_img = pygame.image.load('images/fatalecho (1).png').convert()
mini_logo_img = pygame.image.load('images/logosmall.png').convert()
name_logo_img = pygame.image.load('images/namelogo.png').convert()
